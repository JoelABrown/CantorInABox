...
namespace SoundTouch
{
    ...
    public sealed class SoundTouchProcessor : FifoProcessor
    {
        ...
        /// Hardcoded instead of original: GitVersionInformation.InformationalVersion.
        /// </summary>
        public static string VersionString => "2.6.2.0";

        /// <summary>
        /// Gets the <c>SoundTouch</c> library version Id.
        /// Hardcoded instead of original: GitVersionInformation.AssemblySemFileVer).
        /// </summary>
        public static Version Version => new Version("2.6.2.0");
